...
public class DialogGoidienThoai extends Dialog implements View.OnClickListener {
    ...
    public DialogGoidienThoai(@NonNull Context context) {
        super(context);
        ...
        answerLayout = (LinearLayout) findViewById(R.id.ln_answer);// layout khi dua ra cau tra loi
        callsLayout = (RelativeLayout) findViewById(R.id.rl_calls);// layout tong
        // 1 cái layout tổng chứa 4 layout con
        ...
        // 1 cái imgButton tổng chứa 4 imgButton con
...
//    public static void setTrueAnswer(String dapAnDung) {
//
//    }
